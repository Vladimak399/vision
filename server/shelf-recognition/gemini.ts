...
- middle shelf price tags from left to right;
- bottom shelf price tags from left to right;
- left and right edges;
- partially visible products and partially visible price tags.
...
9. If the photo is too blurry or unreadable, return an empty items array and explain in warnings.
...
- Did you inspect every shelf row?
- Did you include every readable price tag?
- Did you avoid collapsing repeated but different variants?
- Did you mark uncertain links as needs_review instead of omitting them?
